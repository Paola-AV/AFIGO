...
var useChartPolarAxis = ({
  ...
  const svg2rotation = React4.useMemo(() => generateSvg2rotation({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const svg2polar = React4.useMemo(() => generateSvg2polar({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const polar2svg = React4.useMemo(() => generatePolar2svg({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
...
var useChartAnimation = ({
  ...
  const disableAnimation = React5.useCallback(() => {
...
function useCharts(inPlugins, props, seriesConfig5) {
  const chartId = useId();
  const plugins = React8.useMemo(() => [...CHART_CORE_PLUGINS, ...inPlugins], [inPlugins]);
  ...
  const innerSvgRef = React8.useRef(null);
...
var useSelectorSeries3 = createSeriesSelectorsOfType("scatter");
var useSelectorSeriesContext3 = createAllSeriesSelectorOfType("scatter");
...
use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IX6A4G3J.js.map
