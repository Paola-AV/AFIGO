...
var _excluded5 = ["series", "width", "height", "margin", "colors", "sx", "skipAnimation", "hideLegend", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className"];
var defaultMargin = {
  top: 5,
  bottom: 5,
  left: 5,
...
var PieChart = React7.forwardRef(function PieChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime6.jsxs)(ChartsWrapper, {
      ...
      sx,
      children: [!hideLegend && (0, import_jsx_runtime6.jsx)(ChartsLegend, {
