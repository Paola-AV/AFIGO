import {
  NoSsr_default
} from "./chunk-BLM6H5NO.js";
import {
  Popper_default,
  useSlotProps_default
} from "./chunk-A6ZO4EOU.js";
import {
  Typography_default
} from "./chunk-PPWLZJHL.js";
import "./chunk-ZCSSBJ3Q.js";
import {
  useThemeProps
} from "./chunk-YVVIV2XZ.js";
import {
  HTMLElementType
} from "./chunk-PMKSCBH6.js";
import {
  ownerWindow
} from "./chunk-CRFZGP6N.js";
import "./chunk-4OXAPXXZ.js";
import "./chunk-BVR3UIO7.js";
import {
  useLazyRef
} from "./chunk-NEI46K7H.js";
...
} from "./chunk-Z3SHFG4R.js";
import {
  useForkRef
} from "./chunk-7WLYZ6WC.js";
import "./chunk-WFVV4YVW.js";
import "./chunk-JLO3HNGD.js";
import {
  clsx_default,
  composeClasses,
...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React64 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = React64.useSyncExternalStore, useRef12 = React64.useRef, useEffect15 = React64.useEffect, useMemo9 = React64.useMemo, useDebugValue = React64.useDebugValue;
...
var selectorChartLeftAxisSize = createSelector2([selectorChartRawYAxis], (yAxis) => (yAxis ?? []).reduce((acc, axis) => axis.position === "left" ? acc + (axis.width || 0) : acc, 0));
var selectorChartRightAxisSize = createSelector2([selectorChartRawYAxis], (yAxis) => (yAxis ?? []).reduce((acc, axis) => axis.position === "right" ? acc + (axis.width || 0) : acc, 0));
var selectorChartTopAxisSize = createSelector2([selectorChartRawXAxis], (xAxis) => (xAxis ?? []).reduce((acc, axis) => axis.position === "top" ? acc + (axis.height || 0) : acc, 0));
var selectorChartBottomAxisSize = createSelector2([selectorChartRawXAxis], (xAxis) => (xAxis ?? []).reduce((acc, axis) => axis.position === "bottom" ? acc + (axis.height || 0) : acc, 0));
...
var _excluded2 = ["ownerState", "skipAnimation", "id", "dataIndex", "xOrigin", "yOrigin"];
function AnimatedBarElement(props) {
  const {
    ownerState
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded2);
  const animatedProps = useAnimateBar(props);
  return (0, import_jsx_runtime2.jsx)("rect", _extends({}, other, {
...
var _excluded3 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick", "skipAnimation", "layout", "x", "xOrigin", "y", "yOrigin", "width", "height"];
function BarElement(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(Bar, _extends({}, barProps));
}
...
var useChartPolarAxis = ({
  ...
  const svg2rotation = React17.useMemo(() => generateSvg2rotation({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const svg2polar = React17.useMemo(() => generateSvg2polar({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const polar2svg = React17.useMemo(() => generatePolar2svg({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const usedRotationAxisId = rotationAxisIds[0];
  const usedRadiusAxisId = radiusAxisIds[0];
  const mousePosition = React17.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
function useChartGradientIdBuilder() {
  ...
  return React18.useCallback((axisId) => `${chartId}-gradient-${axisId}`, [chartId]);
}
function useChartGradientIdObjectBoundBuilder() {
  const chartId = useChartId2();
  return React18.useCallback((axisId) => `${chartId}-gradient-${axisId}-object-bound`, [chartId]);
}
...
var _excluded4 = ["maskId", "x", "y", "width", "height", "skipAnimation"];
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("rect", _extends({}, animatedProps));
}
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime4.jsx)(BarClipRect, {
      ownerState: rest,
      x: x2,
      y: y2,
      width,
...
var _excluded5 = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes", "skipAnimation", "layout", "xOrigin", "yOrigin"];
...
function BarLabel(inProps) {
  ...
  const otherProps = _objectWithoutPropertiesLoose(props, _excluded5);
  const animatedProps = useAnimateBarLabel(props);
  return (0, import_jsx_runtime5.jsx)(BarLabelComponent, _extends({}, otherProps, animatedProps));
}
...
var _excluded6 = ["seriesId", "classes", "color", "dataIndex", "barLabel", "slots", "slotProps", "xOrigin", "yOrigin", "x", "y", "width", "height", "value", "skipAnimation", "layout"];
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
var _excluded7 = ["bars", "skipAnimation"];
function BarLabelPlot(props) {
  const {
    bars,
    skipAnimation
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded7);
  return (0, import_jsx_runtime7.jsx)(React22.Fragment, {
    children: bars.map(({
      xOrigin,
      yOrigin,
      x: x2,
      ...
      height,
      layout
    }) => (0, import_jsx_runtime7.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color2,
...
var _excluded8 = ["skipAnimation", "onItemClick", "borderRadius", "barLabel"];
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(BarPlotRoot, {
    children: [!withoutBorderRadius && masksData.map(({
      ...
      return (0, import_jsx_runtime8.jsx)(BarClipPath, {
        maskId: id,
        borderRadius,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime8.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color2,
        skipAnimation: skipAnimation ?? false,
    ...
    }), barLabel && (0, import_jsx_runtime8.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation,
      barLabel
    }, other))]
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React24.useState(typeof window !== "undefined" || false);
  React24.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
...
function ChartsText(props) {
  ...
  const wordsByLines = React25.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime9.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime9.jsx)("tspan", {
      x: x2,
...
function ChartsXAxis(inProps) {
  ...
  const _xAxis = xAxis[inProps.axisId ?? xAxisIds[0]], {
    ...
    tickNumber,
    reverse: reverse2
  } = _xAxis, settings = _objectWithoutPropertiesLoose(_xAxis, _excluded10);
  ...
  return (0, import_jsx_runtime10.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime10.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime10.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime10.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && showTickLabel && (0, import_jsx_runtime10.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
          text: tickLabel
...
function ChartsYAxis(inProps) {
  ...
  const _yAxis = yAxis[inProps.axisId ?? yAxisIds[0]], {
    scale: yScale,
    tickNumber
  } = _yAxis, settings = _objectWithoutPropertiesLoose(_yAxis, _excluded11);
  const themedProps = useThemeProps({
    props: _extends({}, settings, inProps),
    name: "MuiChartsYAxis"
  });
  ...
  return (0, import_jsx_runtime11.jsxs)(YAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime11.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime11.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime11.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime11.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
      }, index2);
    }), label && isHydrated && (0, import_jsx_runtime11.jsx)("g", {
      className: classes.label,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime12.jsxs)(React29.Fragment, {
...
var consumeThemeProps = (name, options, InComponent) => React30.forwardRef(function ConsumeThemeInternal(props, ref) {
  var _a;
  const themedProps = useThemeProps({
    props,
  ...
  const OutComponent = React30.forwardRef(InComponent);
  if (true) {
    OutComponent.displayName = `consumeThemeProps(${name})`;
  }
  return (0, import_jsx_runtime13.jsx)(OutComponent, _extends({}, outProps, {
    classes,
    ref
  }));
});
...
var _excluded12 = ["type", "color", "className", "classes"];
...
var ChartsLabelMark = consumeThemeProps("MuiChartsLabelMark", {
  ...
  return (0, import_jsx_runtime14.jsx)(Root, _extends({
    ...
    children: (0, import_jsx_runtime14.jsx)("div", {
      ...
      children: typeof Component === "function" ? (0, import_jsx_runtime14.jsx)(Component, {
        className: classes == null ? void 0 : classes.fill,
        color: color2
      }) : (0, import_jsx_runtime14.jsx)("svg", {
        viewBox: "0 0 24 24",
...
function ChartsItemTooltipContent(props) {
  ...
  if ("values" in tooltipData) {
    ...
    return (0, import_jsx_runtime15.jsx)(ChartsTooltipPaper, {
      ...
      children: (0, import_jsx_runtime15.jsxs)(ChartsTooltipTable, {
        className: classes.table,
        children: [(0, import_jsx_runtime15.jsxs)(Typography_default, {
          component: "caption",
          children: [(0, import_jsx_runtime15.jsx)("div", {
            className: classes.markContainer,
            children: (0, import_jsx_runtime15.jsx)(ChartsLabelMark, {
              type: markType2,
              color: color3,
              className: classes.mark
            })
          }), seriesLabel]
        }), (0, import_jsx_runtime15.jsx)("tbody", {
          children: tooltipData.values.map(({
            formattedValue: formattedValue2,
            label: label2
          }) => (0, import_jsx_runtime15.jsxs)(ChartsTooltipRow, {
    ...
    children: (0, import_jsx_runtime15.jsx)(ChartsTooltipTable, {
      ...
      children: (0, import_jsx_runtime15.jsx)("tbody", {
        children: (0, import_jsx_runtime15.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime15.jsxs)(ChartsTooltipCell, {
            className: clsx_default(classes.labelCell, classes.cell),
            component: "th",
            children: [(0, import_jsx_runtime15.jsx)("div", {
              className: classes.markContainer,
...
function useColorProcessor(seriesType) {
  const store = useStore();
  const seriesConfig5 = useSelector(store, selectorChartSeriesConfig);
  const colorProcessors = React33.useMemo(() => {
    const rep = {};
...
function usePointerType() {
  ...
  const [pointerType, setPointerType] = React34.useState(null);
  React34.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(ChartsTooltipPaper, {
    ...
    children: tooltipData.map(({
      ...
      return (0, import_jsx_runtime16.jsxs)(ChartsTooltipTable, {
        className: classes.table,
        children: [axisValue != null && !mainAxis.hideTooltip && (0, import_jsx_runtime16.jsx)(Typography_default, {
          component: "caption",
...
var _excluded13 = ["trigger", "classes", "children"];
var noAxis = () => false;
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React36.useMemo(() => ({
  ...
  const modifiers = React36.useMemo(() => [{
    name: "offset",
    options: {
      offset: ({
        placement
  ...
  return (0, import_jsx_runtime17.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime17.jsx)(ChartsTooltipRoot, _extends({
...
function ChartsTooltip(props) {
  ...
  const classes = useUtilityClasses5(propClasses);
  return (0, import_jsx_runtime18.jsx)(ChartsTooltipContainer, _extends({}, props, {
    classes,
    children: trigger === "axis" ? (0, import_jsx_runtime18.jsx)(ChartsAxisTooltipContent, {
      classes
    }) : (0, import_jsx_runtime18.jsx)(ChartsItemTooltipContent, {
      classes
    })
  }));
}
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  function ConsumeSlotsInternal(props, ref) {
    ...
    const _useSlotProps = useSlotProps_default({
      ...
      ownerState: {}
    }), originalOutProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded24);
    ...
    return (0, import_jsx_runtime19.jsx)(Component, _extends({}, outProps, {
      ref
    }));
  }
  return React38.forwardRef(ConsumeSlotsInternal);
};
...
var _excluded15 = ["children", "className", "classes"];
var ChartsLabel = consumeThemeProps("MuiChartsLabel", {
  ...
  return (0, import_jsx_runtime20.jsx)("span", _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    children
...
var _excluded16 = ["direction", "onItemClick", "className", "classes"];
...
var ChartsLegend = consumeSlots("MuiChartsLegend", "legend", {
...
}, React40.forwardRef(function ChartsLegend2(props, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(RootElement, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: data.items.map((item, i) => {
      return (0, import_jsx_runtime21.jsx)("li", {
        children: (0, import_jsx_runtime21.jsxs)(Element, {
          ...
          children: [(0, import_jsx_runtime21.jsx)(ChartsLabelMark, {
            ...
            color: item.color,
            type: item.markType
          }), (0, import_jsx_runtime21.jsx)(ChartsLabel, {
...
var _excluded17 = ["gradientId", "direction", "classes", "className", "rotate", "reverse", "thickness"];
...
var ChartsLabelGradient = consumeThemeProps("MuiChartsLabelGradient", {
  ...
  const isRtl = useRtl();
  return (0, import_jsx_runtime22.jsx)(Root2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
...
var _excluded18 = ["minLabel", "maxLabel", "direction", "axisDirection", "axisId", "rotateGradient", "reverse", "classes", "className", "gradientId", "labelPosition", "thickness"];
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  const minComponent = (0, import_jsx_runtime23.jsx)("li", {
    className: classes == null ? void 0 : classes.minLabel,
    children: (0, import_jsx_runtime23.jsx)(ChartsLabel, {
      className: classes == null ? void 0 : classes.label,
      children: minText
    })
  });
  const maxComponent = (0, import_jsx_runtime23.jsx)("li", {
  ...
  return (0, import_jsx_runtime23.jsxs)(RootElement2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: [reverse2 ? maxComponent : minComponent, (0, import_jsx_runtime23.jsx)("li", {
      className: classes == null ? void 0 : classes.gradient,
      children: (0, import_jsx_runtime23.jsx)(ChartsLabelGradient, {
        direction,
...
var _excluded19 = ["direction", "classes", "className", "markType", "labelPosition", "axisDirection", "axisId", "labelFormatter", "onItemClick"];
...
var PiecewiseColorLegend = consumeThemeProps("MuiPiecewiseColorLegend", {
  ...
  return (0, import_jsx_runtime24.jsx)(RootElement3, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: orderedColors.map(({
      ...
      return (0, import_jsx_runtime24.jsx)("li", {
        children: (0, import_jsx_runtime24.jsxs)(Element, {
          role: onItemClick ? "button" : void 0,
          type: onItemClick ? "button" : void 0,
          onClick: (
            // @ts-ignore onClick is only attached to a button
          ...
          children: [isTextBefore && (0, import_jsx_runtime24.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          }), (0, import_jsx_runtime24.jsx)(ChartsLabelMark, {
            className: classes == null ? void 0 : classes.mark,
            type: markType,
            color: color2
          }), isTextAfter && (0, import_jsx_runtime24.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          })]
        })
...
function ChartsYHighlight(props) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React44.Fragment, {
    children: [isBandScaleY && yScale(axisYValue) !== void 0 && (0, import_jsx_runtime25.jsx)(ChartsAxisHighlightPath, {
    ...
    }), type === "line" && axisYValue !== null && (0, import_jsx_runtime25.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return (0, import_jsx_runtime26.jsxs)(React45.Fragment, {
    children: [isBandScaleX && xScale(axisXValue) !== void 0 && (0, import_jsx_runtime26.jsx)(
    ...
    ), type === "line" && axisXValue !== null && (0, import_jsx_runtime26.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React46.Fragment, {
    children: [xAxisHighlight && (0, import_jsx_runtime27.jsx)(ChartsXHighlight, {
      type: xAxisHighlight,
      classes
    }), yAxisHighlight && (0, import_jsx_runtime27.jsx)(ChartsYHighlight, {
      type: yAxisHighlight,
      classes
    })]
  });
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime28.jsx)("clipPath", {
    id,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(React48.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => {
      var _a;
      return (0, import_jsx_runtime29.jsx)(GridLine, {
        y1: start,
        y2: end,
        x1: offset,
        x2: offset,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(React49.Fragment, {
    children: yTicks.map(({
      ...
      var _a;
      return (0, import_jsx_runtime30.jsx)(GridLine, {
        y1: offset,
        y2: offset,
        x1: start,
        x2: end,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime31.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime31.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      start: drawingArea.top,
      end: drawingArea.height + drawingArea.top,
      classes
    }), horizontal && (0, import_jsx_runtime31.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime34.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime34.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
// node_modules/@mui/x-charts/esm/BarChart/useBarChartProps.js
var _excluded26 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className", "hideLegend"];
var useBarChartProps = (props) => {
  ...
  const defaultBandYAxis = React54.useMemo(() => [{
    id: DEFAULT_Y_AXIS_KEY,
    scaleType: "band",
    data: Array.from({
      length: Math.max(...series.map((s2) => (s2.data ?? dataset ?? []).length))
  ...
  const seriesWithDefault = React54.useMemo(() => series.map((s2) => _extends({
    type: "bar"
  }, s2, {
...
var useChartVoronoi = ({
  ...
  const voronoiRef = React55.useRef({});
  const delauneyRef = React55.useRef(void 0);
  const lastFind = React55.useRef(void 0);
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  useEnhancedEffect_default(() => {
...
var _excluded27 = ["children", "plugins", "seriesConfig"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children
  }));
}
true ? ChartDataProvider.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  apiRef: import_prop_types22.default.shape({
   ...
   */
  series: import_prop_types22.default.arrayOf(import_prop_types22.default.object),
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
  skipAnimation: import_prop_types22.default.bool,
  theme: import_prop_types22.default.oneOf(["dark", "light"]),
  /**
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime36.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime36.jsxs)(React57.Fragment, {
        children: [(0, import_jsx_runtime36.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime36.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime37.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime37.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime38.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime38.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime39.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime39.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime39.jsxs)(React60.Fragment, {
          children: [(0, import_jsx_runtime39.jsx)(ChartsContinuousGradient, {
            isReversed: !reverse2,
            scale: scale2,
            colorScale,
            colorMap,
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime39.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime39.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var _excluded28 = ["children", "className", "title", "desc"];
...
var ChartsSurface = React61.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore();
  const {
    width: svgWidth,
    height: svgHeight
  ...
  return (0, import_jsx_runtime40.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime40.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime40.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime40.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
var _excluded29 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins"];
...
function ChartsWrapper(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(Root3, {
    ownerState: props,
    sx,
    children
  });
...
var BarChart = React63.forwardRef(function BarChart2(inProps, ref) {
  var _a, _b;
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  ...
  return (0, import_jsx_runtime42.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime42.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [!props.hideLegend && (0, import_jsx_runtime42.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime42.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime42.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime42.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime42.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime42.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime42.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
        })), (0, import_jsx_runtime42.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), !props.loading && (0, import_jsx_runtime42.jsx)(Tooltip, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.tooltip)), (0, import_jsx_runtime42.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      }))]
    }))
  }));
});
true ? BarChart.propTypes = {
   ...
   * @returns {string} The formatted label.
   */
  barLabel: import_prop_types24.default.oneOfType([import_prop_types24.default.oneOf(["value"]), import_prop_types24.default.func]),
  /**
   * Defines the border radius of the bar element.
   */
  borderRadius: import_prop_types24.default.number,
   ...
   * @default 'vertical'
   */
  layout: import_prop_types24.default.oneOf(["horizontal", "vertical"]),
  /**
   ...
   */
  xAxis: import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.shape({
    axis: import_prop_types24.default.oneOf(["x"]),
    barGapRatio: import_prop_types24.default.number,
    categoryGapRatio: import_prop_types24.default.number,
    ...
    domainLimit: import_prop_types24.default.oneOfType([import_prop_types24.default.oneOf(["nice", "strict"]), import_prop_types24.default.func]),
    ...
    ignoreTooltip: import_prop_types24.default.bool,
    label: import_prop_types24.default.string,
    labelStyle: import_prop_types24.default.object,
    max: import_prop_types24.default.oneOfType([import_prop_types24.default.instanceOf(Date), import_prop_types24.default.number]),
    min: import_prop_types24.default.oneOfType([import_prop_types24.default.instanceOf(Date), import_prop_types24.default.number]),
    offset: import_prop_types24.default.number,
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["band"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    ...
    tickLabelMinGap: import_prop_types24.default.number,
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["point"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    stroke: import_prop_types24.default.string,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["log"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    stroke: import_prop_types24.default.string,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["pow"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    stroke: import_prop_types24.default.string,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["sqrt"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    stroke: import_prop_types24.default.string,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["time"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    stroke: import_prop_types24.default.string,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["utc"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    stroke: import_prop_types24.default.string,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["linear"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    stroke: import_prop_types24.default.string,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.shape({
    ...
    min: import_prop_types24.default.oneOfType([import_prop_types24.default.instanceOf(Date), import_prop_types24.default.number]),
    offset: import_prop_types24.default.number,
    position: import_prop_types24.default.oneOf(["left", "none", "right"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["band"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
