import {
  ...
  useYScale,
  warnOnce
} from "./chunk-IX6A4G3J.js";
import "./chunk-WW5WQZ5X.js";
import {
  useSlotProps_default
} from "./chunk-NKQSGNCC.js";
import "./chunk-YVTBBSN5.js";
import {
  useThemeProps
} from "./chunk-Z7AOZXH5.js";
import "./chunk-U3XLL43B.js";
import "./chunk-2CRJUMXP.js";
import "./chunk-CLAKU4P5.js";
import "./chunk-ZCSSBJ3Q.js";
import "./chunk-FV27OH4H.js";
...
import "./chunk-ZDAEOYRC.js";
import "./chunk-67AXNCSJ.js";
import "./chunk-5QRBCCOS.js";
import "./chunk-7WLYZ6WC.js";
import "./chunk-JUYSEPSV.js";
import "./chunk-KVPV6S6L.js";
import {
  composeClasses,
...
var _excluded3 = ["maskId", "x", "y", "width", "height", "skipAnimation"];
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime3.jsx)("rect", _extends({}, animatedProps));
}
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime3.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime3.jsx)(BarClipRect, {
      ownerState: rest,
      x,
      y,
      width,
...
var _excluded4 = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes", "skipAnimation", "layout", "xOrigin", "yOrigin"];
...
var _excluded5 = ["seriesId", "classes", "color", "dataIndex", "barLabel", "slots", "slotProps", "xOrigin", "yOrigin", "x", "y", "width", "height", "value", "skipAnimation", "layout"];
...
var _excluded8 = ["x", "y", "style", "text", "ownerState"];
...
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded8);
...
function ChartsXAxis(inProps) {
  ...
  const _xAxis = xAxis[inProps.axisId ?? xAxisIds[0]], {
    ...
    tickNumber,
    reverse
  } = _xAxis, settings = _objectWithoutPropertiesLoose(_xAxis, _excluded9);
    ...
    children: [!disableLine && (0, import_jsx_runtime10.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime10.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime10.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime10.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
...
function ChartsYHighlight(props) {
  ...
  return (0, import_jsx_runtime12.jsxs)(React14.Fragment, {
    children: [isBandScaleY && yScale(axisYValue) !== void 0 && (0, import_jsx_runtime12.jsx)(ChartsAxisHighlightPath, {
    ...
    }), type === "line" && axisYValue !== null && (0, import_jsx_runtime12.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React15.Fragment, {
    children: [isBandScaleX && xScale(axisXValue) !== void 0 && (0, import_jsx_runtime13.jsx)(
    ...
    ), type === "line" && axisXValue !== null && (0, import_jsx_runtime13.jsx)(ChartsAxisHighlightPath, {
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(React18.Fragment, {
    children: xTicks.map(({
      ...
      var _a;
      return (0, import_jsx_runtime16.jsx)(GridLine, {
        y1: start,
        y2: end,
        x1: offset,
        x2: offset,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(React19.Fragment, {
    children: yTicks.map(({
      ...
      var _a;
      return (0, import_jsx_runtime17.jsx)(GridLine, {
        y1: offset,
        y2: offset,
        x1: start,
        x2: end,
...
// node_modules/@mui/x-charts/esm/BarChart/useBarChartProps.js
var _excluded12 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className", "hideLegend"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React21.useMemo(() => [{
  ...
  const defaultBandYAxis = React21.useMemo(() => [{
  ...
  const seriesWithDefault = React21.useMemo(() => series.map((s) => _extends({
    type: "bar"
  }, s, {
...
var BarChart = React22.forwardRef(function BarChart2(inProps, ref) {
  var _a, _b;
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  ...
  return (0, import_jsx_runtime19.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime19.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [!props.hideLegend && (0, import_jsx_runtime19.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime19.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        ...
        })), (0, import_jsx_runtime19.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), !props.loading && (0, import_jsx_runtime19.jsx)(Tooltip, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.tooltip)), (0, import_jsx_runtime19.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      }))]
    }))
  }));
});
