...
var consumeThemeProps = (name, options, InComponent) => React16.forwardRef(function ConsumeThemeInternal(props, ref) {
  var _a;
  ...
  const OutComponent = React16.forwardRef(InComponent);
  if (true) {
...
function useColorProcessor(seriesType) {
  const store = useStore();
  const seriesConfig5 = useSelector(store, selectorChartSeriesConfig);
  const colorProcessors = React19.useMemo(() => {
    const rep = {};
...
function usePointerType() {
  ...
  const [pointerType, setPointerType] = React20.useState(null);
  React20.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React22.useMemo(() => ({
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React24.forwardRef(ConsumeSlotsInternal);
};
...
}, React26.forwardRef(function ChartsLegend2(props, ref) {
...
var useInteractionItemProps = (data, skip) => {
  ...
  const interactionActive = React30.useRef(false);
  const onPointerEnter = React30.useCallback(() => {
  ...
  const onPointerLeave = React30.useCallback(() => {
  ...
  return (0, import_jsx_runtime17.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime17.jsxs)(React34.Fragment, {
        children: [(0, import_jsx_runtime17.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime17.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime18.jsx)("linearGradient", {
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime18.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime19.jsx)("linearGradient", _extends({
    id: gradientId
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime20.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime20.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime20.jsxs)(React37.Fragment, {
          children: [(0, import_jsx_runtime20.jsx)(ChartsContinuousGradient, {
            isReversed: !reverse2,
            scale: scale2,
            colorScale,
            colorMap,
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime20.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime20.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var _excluded12 = ["children", "className", "title", "desc"];
...
var ChartsSurface = React38.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime21.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime21.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime21.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
var useChartVoronoi = ({
  ...
  const voronoiRef = React39.useRef({});
  const delauneyRef = React39.useRef(void 0);
  const lastFind = React39.useRef(void 0);
...
var _excluded13 = ["children", "plugins", "seriesConfig"];
...
use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7HF3WMFN.js.map
