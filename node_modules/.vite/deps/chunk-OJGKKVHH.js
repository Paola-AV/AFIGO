  ...
  return (0, import_jsx_runtime2.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime2.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime2.jsxs)("g", {
        ...
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && showTickLabel && (0, import_jsx_runtime2.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
          text: tickLabel
...
true ? ChartsXAxis.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axis: import_prop_types2.default.oneOf(["x"]),
  /**
   ...
   * @default 4
   */
  tickLabelMinGap: import_prop_types2.default.number,
  /**
    ...
    children: [!disableLine && (0, import_jsx_runtime3.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime3.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime3.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime3.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
      }, index);
    }), label && isHydrated && (0, import_jsx_runtime3.jsx)("g", {
      className: classes.label,
...
true ? ChartsYAxis.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axis: import_prop_types3.default.oneOf(["y"]),
  /**
   * The id of the axis to render.
   * If undefined, it will be the first defined axis.
   */
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime4.jsxs)(React6.Fragment, {
    children: [xAxisIds.map((axisId) => {
      ...
      return (0, import_jsx_runtime4.jsx)(ChartsXAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
      ...
      return (0, import_jsx_runtime4.jsx)(ChartsYAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
...
function ChartsYHighlight(props) {
  ...
  return (0, import_jsx_runtime5.jsxs)(React7.Fragment, {
    children: [isBandScaleY && yScale(axisYValue) !== void 0 && (0, import_jsx_runtime5.jsx)(ChartsAxisHighlightPath, {
    ...
    }), type === "line" && axisYValue !== null && (0, import_jsx_runtime5.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return (0, import_jsx_runtime6.jsxs)(React8.Fragment, {
    children: [isBandScaleX && xScale(axisXValue) !== void 0 && (0, import_jsx_runtime6.jsx)(
    ...
    ), type === "line" && axisXValue !== null && (0, import_jsx_runtime6.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)(React9.Fragment, {
    children: [xAxisHighlight && (0, import_jsx_runtime7.jsx)(ChartsXHighlight, {
      type: xAxisHighlight,
      classes
    }), yAxisHighlight && (0, import_jsx_runtime7.jsx)(ChartsYHighlight, {
      type: yAxisHighlight,
      classes
    })]
  });
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(React11.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => {
      var _a;
      return (0, import_jsx_runtime9.jsx)(GridLine, {
        y1: start,
        y2: end,
        x1: offset,
        x2: offset,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(React12.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => {
      var _a;
      return (0, import_jsx_runtime10.jsx)(GridLine, {
        y1: offset,
        y2: offset,
        x1: start,
        x2: end,
...
//# sourceMappingURL=chunk-OJGKKVHH.js.map
